...
from fastapi import APIRouter, File, Form, UploadFile, HTTPException, Header, status
...
async def upload_document(
    ...
    markdown_content, warnings = document_service.convert_to_markdown(file_bytes, ext, fast_mode)
